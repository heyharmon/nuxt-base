...
const variantClasses = {
  bold: 'text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm',
  light: 'text-indigo-600 bg-indigo-100 hover:bg-indigo-200 shadow-sm',
  ghost: 'text-indigo-600 bg-transparent ring-2 ring-inset ring-indigo-600 hover:bg-indigo-100',
  text: 'text-indigo-600 bg-transparent px-0',
}
